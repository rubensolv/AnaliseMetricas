...
public class MainTestes {
	...
	public static void main(String[] args) {
		File diretorio = new File("/media/rubens/Dados/MetricDados/Simulacao/EstadoNumber1");
	...
	public static void gerarDadosCombinacao(ArrayList<Combinacao> combinacoes, ArrayList<Summary> summaries, File diretorio){
